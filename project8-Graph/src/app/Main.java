...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		int[][] edges = new int[][]
		{
            ...
            {6, 5, 8}, {6, 7, 6},
            {7, 6, 6}, {7, 5, 9}, {7, 9, 12}, {7, 8, 7}, {7, 14, 10}, {7, 13, 23},
            ...
            {14, 12, 15}, {14, 13, 18}, {14, 7, 10}, {14, 8, 6}, {14, 10, 8}, {14, 11, 9}
		};

		graph.makeGraph(edges);
		graph.printGraph(edges);
		System.out.println("\n");
	    System.out.println(graph.getDistance(6, 7));
	    System.out.println(graph.getNeighbors(9));
	}
